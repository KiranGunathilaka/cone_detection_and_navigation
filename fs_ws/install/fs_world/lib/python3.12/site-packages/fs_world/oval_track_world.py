...
import math
import pathlib
from ament_index_python.packages import get_package_share_directory  # ✅ THIS is required
...
def main():
    ...
    # Always write into the installed share/<pkg>/fs_world directory
    share_dir = pathlib.Path(get_package_share_directory("fs_world"))  # resolves to .../install/fs_world/share/fs_world
    out_dir = share_dir / "fs_world"                                   # .../share/fs_world/fs_world
    out_dir.mkdir(parents=True, exist_ok=True)

    out = out_dir / "fs_oval.world"
    out.write_text(sdf)
    print(" Wrote world to:", out)
